...
class Users(UserMixin, db.Model):
    ...
    middle_initial = db.Column(db.CHAR(10), nullable=False)
    contact_number = db.Column(db.String(11))
    sex = db.Column(db.CHAR(1), nullable=False)
    birth_date = db.Column(db.DATE, nullable=False)

    def __init__(self, username='', password='', first_name='', last_name='', middle_initial='', contact_number='', sex='', birth_date=''):
